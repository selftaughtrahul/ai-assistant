...
def test_intent_classifier_custom_model_and_intents():
    ...
    custom_model_name = "prajjwal1/bert-tiny" # very small model for testing purposes
    custom_intents = ["Positive", "Negative", "Neutral"]
    
    clf = IntentClassifier(model_name=custom_model_name, intents=custom_intents)
    assert clf.tokenizer is not None
...
def test_intent_classifier_dynamic_prediction():
    ...
    custom_model_name = "prajjwal1/bert-tiny" 
